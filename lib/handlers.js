...
handlers._users.get = function(data,callback){
  ...
  this part is for token verification- >
   
  // get the token from the headers
    var token = typeof(data.headers.token) == 'string' ? data.headers.token : false;
    // verify that the given tokem is valid for the phone number
...
// token container for all the methods
handlers._tokens = {};
